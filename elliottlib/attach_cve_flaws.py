...
def get_corresponding_flaw_bugs(bug_tracker, tracker_bugs, fields, strict=False):
    """
    ...
    blocking_bugs = bug_tracker.get_bugs(unique(flatten([t.blocks for t in tracker_bugs])),
                                         include_fields=fields)
