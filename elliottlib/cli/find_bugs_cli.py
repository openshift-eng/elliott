...
@pass_runtime
def find_bugs_cli(runtime, advisory, default_advisory_type, mode, status, exclude_status, id, cve_trackers, from_diff,
...
"""
    ...
    click.echo(" {}".format(", ".join(sorted(str(b.bug_id) for b in bugs))))
