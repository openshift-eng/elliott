...
@cli.command("find-bugs:list", short_help="List and (optional) add bugs to ADVISORY")
...
@click.pass_obj
def find_bugs_list_cli(runtime: Runtime, advisory, default_advisory_type, bug_ids, report, output, use_jira, noop):
    """List and (optional) add OCP Bugs to ADVISORY
Print bug details with --report
For attaching use --add, --use-default-advisory <TYPE>

    Print bug report

\b
    $ elliott -g openshift-4.10 find-bugs:list 8675309 7001337 --report


    Attach bugs to the advisory 123456

\b
    $ elliott -g openshift-4.10 find-bugs:list 8675309 7001337 --attach 123456


    Attach bugs to the 4.10.2 assembly defined image advisory

\b
    $ elliott -g openshift-4.10 --assembly 4.10.2 find-bugs:list 8675309 7001337 --use-default-advisory image
